...
const NOSTR_BLUE_URL = 'https://nostr.blue';
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              ...
              <Card className="group hover:border-sovereign/50 transition-all duration-300 overflow-hidden rounded-lg py-0! gap-0! flex flex-col">
                <CardContent className="p-6 flex flex-col flex-1">
                  <div className="flex items-center gap-4 mb-6">
                    <a href={NOSTR_BLUE_URL} target="_blank" rel="noopener noreferrer" className="w-14 h-14 rounded-full bg-sovereign flex items-center justify-center text-white text-2xl hover:opacity-90 transition-opacity">
                      🌐
                    </a>
                    <div>
                      <a href={NOSTR_BLUE_URL} target="_blank" rel="noopener noreferrer" className="font-semibold text-xl hover:text-sovereign transition-colors">
                        nostr.blue
                      </a>
                      <p className="text-sm text-muted-foreground">Nostr Client & Platform</p>
                    </div>
                  </div>
                  <p className="text-muted-foreground mb-6 flex-1">
                    One of the most complete Nostr clients available. Featuring social feeds, live audio, long-form articles, and direct messaging.
                  </p>
                  <Button 
                    asChild
                    className="w-full bg-sovereign hover:bg-sovereign/90 text-white"
                  >
                    <a href={NOSTR_BLUE_URL} target="_blank" rel="noopener noreferrer">
                      Explore nostr.blue
                    </a>
                  </Button>
                </CardContent>
