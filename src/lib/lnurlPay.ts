 ...
 *
 * `fetchImpl` defaults to the global `fetch`; this site routes LNURL requests
 * through a CORS proxy by passing a wrapped fetch here. Validation still sees
 * the real HTTPS URL — only the transport is proxied.
 */
